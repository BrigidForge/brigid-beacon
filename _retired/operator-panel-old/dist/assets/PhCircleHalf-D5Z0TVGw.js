import{p as n,O as s,s as g}from"./react-vendor-DtDoD7Ju.js";import{n as m,Y as c,t as r}from"./lit-element-_I0wWAMV.js";var V=Object.defineProperty,d=Object.getOwnPropertyDescriptor,o=(a,i,l,p)=>{for(var e=p>1?void 0:p?d(i,l):i,h=a.length-1,Z;h>=0;h--)(Z=a[h])&&(e=(p?Z(i,l,e):Z(e))||e);return p&&e&&V(i,l,e),e};let t=class extends m{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return c`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([g("ph-circle-half")],t);export{t as PhCircleHalf};
