import{p as g,O as i,s as d}from"./react-vendor-fypzqDBl.js";import{n as c,Y as u,t as r}from"./lit-element-3hFzkjVg.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(a,l,p,s)=>{for(var e=s>1?void 0:s?y(l,p):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(e=(s?n(l,p,e):n(e))||e);return s&&e&&w(l,p,e),e};let t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return u`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-caret-up")],t);export{t as PhCaretUp};
