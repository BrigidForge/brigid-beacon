import{p as l,O as i,s as n}from"./react-vendor-fypzqDBl.js";import{n as g,Y as c,t as a}from"./lit-element-3hFzkjVg.js";var d=Object.defineProperty,Z=Object.getOwnPropertyDescriptor,o=(r,H,h,V)=>{for(var e=V>1?void 0:V?Z(H,h):H,p=r.length-1,s;p>=0;p--)(s=r[p])&&(e=(V?s(H,h,e):s(e))||e);return V&&e&&d(H,h,e),e};let t=class extends g{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var r;return c`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([n("ph-copy")],t);export{t as PhCopy};
