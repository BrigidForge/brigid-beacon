import{p as n,O as s,s as M}from"./react-vendor-fypzqDBl.js";import{n as V,Y as g,t as r}from"./lit-element-3hFzkjVg.js";var H=Object.defineProperty,m=Object.getOwnPropertyDescriptor,o=(a,l,p,i)=>{for(var e=i>1?void 0:i?m(l,p):l,h=a.length-1,Z;h>=0;h--)(Z=a[h])&&(e=(i?Z(l,p,e):Z(e))||e);return i&&e&&H(l,p,e),e};let t=class extends V{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([M("ph-envelope")],t);export{t as PhEnvelope};
