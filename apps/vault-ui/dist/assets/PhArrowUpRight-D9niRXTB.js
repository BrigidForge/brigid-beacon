import{p as g,O as p,s as d}from"./react-vendor-fypzqDBl.js";import{n as u,Y as c,t as r}from"./lit-element-3hFzkjVg.js";var w=Object.defineProperty,L=Object.getOwnPropertyDescriptor,a=(o,s,h,i)=>{for(var e=i>1?void 0:i?L(s,h):s,l=o.length-1,n;l>=0;l--)(n=o[l])&&(e=(i?n(s,h,e):n(e))||e);return i&&e&&w(s,h,e),e};let t=class extends u{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var o;return c`<svg
  ...
  `;a([p({type:String,reflect:!0})],t.prototype,"size",2);a([p({type:String,reflect:!0})],t.prototype,"weight",2);a([p({type:String,reflect:!0})],t.prototype,"color",2);a([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=a([d("ph-arrow-up-right")],t);export{t as PhArrowUpRight};
