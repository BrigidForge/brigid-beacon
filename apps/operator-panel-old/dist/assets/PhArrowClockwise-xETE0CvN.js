import{p as g,O as i,s as c}from"./react-vendor-DtDoD7Ju.js";import{n as d,Y as w,t as r}from"./lit-element-_I0wWAMV.js";var u=Object.defineProperty,A=Object.getOwnPropertyDescriptor,o=(a,l,s,h)=>{for(var e=h>1?void 0:h?A(l,s):l,p=a.length-1,n;p>=0;p--)(n=a[p])&&(e=(h?n(l,s,e):n(e))||e);return h&&e&&u(l,s,e),e};let t=class extends d{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return w`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-arrow-clockwise")],t);export{t as PhArrowClockwise};
