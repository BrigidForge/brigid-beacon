import{p as g,O as s,s as d}from"./react-vendor-DtDoD7Ju.js";import{n as c,Y as u,t as r}from"./lit-element-_I0wWAMV.js";var w=Object.defineProperty,y=Object.getOwnPropertyDescriptor,o=(l,a,p,i)=>{for(var e=i>1?void 0:i?y(a,p):a,h=l.length-1,n;h>=0;h--)(n=l[h])&&(e=(i?n(a,p,e):n(e))||e);return i&&e&&w(a,p,e),e};let t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var l;return u`<svg
  ...
  `;o([s({type:String,reflect:!0})],t.prototype,"size",2);o([s({type:String,reflect:!0})],t.prototype,"weight",2);o([s({type:String,reflect:!0})],t.prototype,"color",2);o([s({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-caret-down")],t);export{t as PhCaretDown};
