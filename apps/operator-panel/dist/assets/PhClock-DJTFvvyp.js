import{p as g,O as p,s as c}from"./react-vendor-DtDoD7Ju.js";import{n as m,Y as Z,t as r}from"./lit-element-_I0wWAMV.js";var d=Object.defineProperty,u=Object.getOwnPropertyDescriptor,o=(a,h,s,i)=>{for(var e=i>1?void 0:i?u(h,s):h,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(i?n(h,s,e):n(e))||e);return i&&e&&d(h,s,e),e};let t=class extends m{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return Z`<svg
  ...
  `;o([p({type:String,reflect:!0})],t.prototype,"size",2);o([p({type:String,reflect:!0})],t.prototype,"weight",2);o([p({type:String,reflect:!0})],t.prototype,"color",2);o([p({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([c("ph-clock")],t);export{t as PhClock};
