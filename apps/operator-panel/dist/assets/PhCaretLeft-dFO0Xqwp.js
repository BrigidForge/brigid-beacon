import{p as g,O as i,s as d}from"./react-vendor-DtDoD7Ju.js";import{n as c,Y as u,t as e}from"./lit-element-_I0wWAMV.js";var f=Object.defineProperty,w=Object.getOwnPropertyDescriptor,o=(a,l,p,s)=>{for(var r=s>1?void 0:s?w(l,p):l,h=a.length-1,n;h>=0;h--)(n=a[h])&&(r=(s?n(l,p,r):n(r))||r);return s&&r&&f(l,p,r),r};let t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return u`<svg
  ...
  `;o([i({type:String,reflect:!0})],t.prototype,"size",2);o([i({type:String,reflect:!0})],t.prototype,"weight",2);o([i({type:String,reflect:!0})],t.prototype,"color",2);o([i({type:Boolean,reflect:!0})],t.prototype,"mirrored",2);t=o([d("ph-caret-left")],t);export{t as PhCaretLeft};
