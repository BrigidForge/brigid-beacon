        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          <div className="flex items-center gap-5">
            ...
            <nav className="hidden items-center gap-3 text-sm text-slate-400 sm:flex">
              <Link to="/owner/portfolio" className="rounded-full border border-white/10 px-3 py-1.5 hover:border-emerald-300/30 hover:text-emerald-100">
                Owner Portfolio
              </Link>
              <Link to="/operator" className="rounded-full border border-white/10 px-3 py-1.5 hover:border-sky-300/30 hover:text-sky-100">
                Operator
              </Link>
          ...
          <p className="hidden text-sm text-slate-400 sm:block">Public visibility for indexed BrigidVaults</p>
        </div>
      </header>
